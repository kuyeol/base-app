...
public class FruitResource {
  ...
  public List<Fruit> get() {
    return entityManager.createNamedQuery("Fruit_list.findAll", Fruit.class).getResultList();
  }
  ...
  public Fruit searchForName(
    ...
    if (fruit == null) {
      throw new WebApplicationException("Fruit with id of " + name + " does not exist.", 404);
    }
    return fruit;
  }
