package org.acme.connector.config;

import java.util.Map;
import org.apache.kafka.common.config.AbstractConfig;
import org.apache.kafka.common.config.ConfigDef;

public class UngConnectorConfig extends AbstractConfig {

  public UngConnectorConfig(final Map<String, ?> configProps) {
  ...
  public static final ConfigDef CONFIG_DEF =
      new ConfigDef().define(API_URL_CONFIG,
                         ConfigDef.Type.STRING,
                         ConfigDef.Importance.HIGH,
                         "URL for the desired API call")
                     .define(API_POLL_INTERVAL,
                         ConfigDef.Type.LONG,
                         10_000,
                         ConfigDef.Importance.MEDIUM,
                         "Time to set for polling interval in millis")
                     .define(RECONFIGURE_TIMEOUT_CHECK,
                         ConfigDef.Type.INT,
                         60_000,
                         ConfigDef.Importance.MEDIUM,
                         "Time to wait for checking if a reconfiguration is needed, to disable monitoring set this config to 0")
                     .define(TOPIC_CONFIG,
                         ConfigDef.Type.STRING,
                         ConfigDef.Importance.HIGH,
                     ...
                     .define(TOKEN_CONFIG,
                         ...
                         ConfigDef.Importance.HIGH,
                         "The security token for authorizing the API call")
                     .define(RESULT_NODE_PATH,
                         ConfigDef.Type.STRING,
                         ConfigDef.Importance.MEDIUM,
                         "The path to the json node that is the parent of stock API results")
                     .define(TASK_BATCH_SIZE_CONFIG,
                         ConfigDef.Type.INT, DEFAULT_TASK_BATCH_SIZE,
                         ConfigDef.Importance.LOW,
                         "The maximum number of records the Source task can read the stock API feed at one time")
                     .define(SERVICE_URL_CONFIG,
                         ConfigDef.Type.STRING,
                         ConfigDef.Importance.HIGH,
                         "The service URL to retrieve ticker symbols");
}
