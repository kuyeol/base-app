...
public class UngSourceConnectorMonitorThread  extends Thread {





  private static final Logger LOG = LoggerFactory.getLogger(UngSourceConnectorMonitorThread.class);
  ...
  public UngSourceConnectorMonitorThread(final ConnectorContext connectorContext,
