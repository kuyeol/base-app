...
public class UngSourceTask extends SourceTask {

  private static final Logger LOG = LoggerFactory.getLogger(UngSourceTask.class);
  ...
  public UngSourceTask(Time sourceTime) {
    this.sourceTime = sourceTime;
  }

  public UngSourceTask() {
  ...
  public void start(Map<String, String> props) {
    ...
    apiUrl = props.get(UngConnectorConfig.API_URL_CONFIG);
    topic = props.get(UngConnectorConfig.TOPIC_CONFIG);
    timeBetweenPoll = Long.parseLong(props.get(UngConnectorConfig.API_POLL_INTERVAL));
    lastUpdate.set(sourceTime.milliseconds() - timeBetweenPoll);
    resultNodePath = props.get(UngConnectorConfig.RESULT_NODE_PATH);
  ...
  String getRequestString(Map<String, String> props) {
    return stringBuilder.append(props.get(UngConnectorConfig.API_URL_CONFIG))
                        .append("?")
                        .append("access_key=").append(props.get(UngConnectorConfig.TOKEN_CONFIG))
                        .append("&")
                        .append("symbols=").append(props.get(UngConnectorConfig.TICKER_SYMBOL_CONFIG))
                        .toString();
  }
