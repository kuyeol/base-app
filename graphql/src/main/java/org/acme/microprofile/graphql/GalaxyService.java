...
import org.acme.microprofile.graphql.ext.Ally;
...
public class GalaxyService {
  ...
  public List<Hero> getHeroesBySurname(String surname) {
    return heroes.stream().filter(hero -> hero.getSurname().equals(surname)).collect(Collectors.toList());
  }

  ////////////////동맹추가

  private List<Ally> patner = new ArrayList<>();

  @Query
  public List<Ally> getPartner() {
    return patner;
  }
}
