...
public class InitDatabase {
  ...
  private void initDb() {
    ...
    client.query("DROP TABLE IF EXISTS productcategory").execute()
          .flatMap(r -> client.query(
              "CREATE TABLE productcategory (id SERIAL PRIMARY KEY, productid SERIAL, categoryid SERIAL)").execute())
          .await().indefinitely()
    ;
  }
  ...
  private void addProducts() {
    addProductAndWait(Long.valueOf(1), new BigDecimal("29.99"), "Return of the Jedi",
        "Episode 6, Luke has the final confrontation with his father!", "images/Return.jpg");
    addProductAndWait(Long.valueOf(2), new BigDecimal("29.99"), "Empire Strikes Back",
        "Episode 5, Luke finds out a secret that will change his destiny", "images/Empire.jpg");
    addProductAndWait(Long.valueOf(3), new BigDecimal("29.99"), "New Hope",
        "Episode 4, after years of oppression, a band of rebels fight for freedom", "images/NewHope.jpg");
    addProductAndWait(Long.valueOf(10), new BigDecimal("100.00"), "DVD Player",
        "This Sony Player has crystal clear picture", "images/Player.jpg");
    addProductAndWait(Long.valueOf(20), new BigDecimal("200.00"), "BlackBerry Curve",
        "This BlackBerry offers rich PDA functions and works with Notes.", "images/BlackBerry.jpg");
    addProductAndWait(Long.valueOf(21), new BigDecimal("150.00"), "Sony Ericsson",
        "This Sony phone takes pictures and plays Music.", "images/SonyPhone.jpg");
    addProductAndWait(Long.valueOf(30), new BigDecimal("1800.00"), "Sony Bravia", "This is a 40 inch 1080p LCD HDTV",
        "images/SonyTV.jpg");
    addProductAndWait(Long.valueOf(31), new BigDecimal("1150.00"), "Sharp Aquos", "This is 32 inch 1080p LCD HDTV",
        "images/SamTV.jpg");
    addProductAndWait(Long.valueOf(40), new BigDecimal("20.00"), "Go Fish: Superstar",
        "Go Fish release their great new hit, Superstar", "images/Superstar.jpg");
    addProductAndWait(Long.valueOf(41), new BigDecimal("20.00"), "Ludwig van Beethoven",
        "This is a classic, the 9 Symphonies Box Set", "images/Bet.jpg");
    addProductAndWait(Long.valueOf(51), new BigDecimal("399.99"), "PlayStation 3",
        "Brace yourself for the marvels of the PlayStation 3 complete with 80GB hard disk storage", "images/PS3.jpg");
    addProductAndWait(Long.valueOf(52), new BigDecimal("169.99"), "Nintendo Wii",
        "Next-generation gaming with a motion-sensitive controller", "images/wii.jpg");
    addProductAndWait(Long.valueOf(53), new BigDecimal("299.99"), "XBOX 360",
        "Expand your horizons with the gaming and multimedia capabilities of this incredible system",
        "images/xbox360.jpg");
  }
  ...
  public CompletionStage<Product> addProduct(Long id, BigDecimal price, String name, String description, String image) {
    ...
    return client.preparedQuery(
                     "INSERT INTO product (id, price, name, description, image) VALUES ($1, $2, $3, $4, $5) RETURNING (id)").execute(
                     Tuple.of(id, price, name, description, image))
  ...
  public CompletionStage<ProductCategory> addProductCategory(Long id, Long productId, Long categoryId) {
    ...
    return client.preparedQuery(
                 ...
                 .execute(Tuple.of(id, productId, categoryId))
                 //.toCompletableFuture()
                 //.orTimeout(MAXIMAL_DURATION, TimeUnit.MILLISECONDS)
                 .onItem()
                 .transform(pgRowSet -> {
