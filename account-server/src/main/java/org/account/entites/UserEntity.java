...
@NamedQueries(
        ...
        @NamedQuery(
                ...
                query = "select u from UserEntity u where u.firstName = :first and u.lastName = :last and u.realmId = :realmId"),

        @NamedQuery(
                name = "getRealmUserByServiceAccount",
                query = "select u from UserEntity u where u.serviceAccountClientLink = :clientInternalId and u.realmId = :realmId"),
        ...
        @NamedQuery(
                name = "getRealmUserCountExcludeServiceAccount",
                query = "select count(u) from UserEntity u where u.realmId = :realmId and (u.serviceAccountClientLink is null)"),

        @NamedQuery(
                name = "deleteUsersByRealm",
                query = "delete from UserEntity u whereu.realmId = :realmId"),
        ...
        @NamedQuery(
                name = "unlinkUsers",
                query = "update UserEntity u set u.federationLink = null where u.realmId = :realmId and u.federationLink=:link")
        })
